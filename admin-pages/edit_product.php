               ...
               <form method="post" class="form-horizontal" enctype="multipart/form-data"><!-- form-horizontal Begin -->
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="admin_images/<?php echo $p_image1; ?>" alt="<?php echo $p_image1; ?>">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="admin_images/<?php echo $p_image2; ?>" alt="<?php echo $p_image2; ?>">
                   ...
                   <div class="form-group"><!-- form-group Begin -->
                      ...
                      <div class="col-md-6"><!-- col-md-6 Begin -->
                          ...
                          <img width="70" height="70" src="admin_images/<?php echo $p_image3; ?>" alt="<?php echo $p_image3; ?>">
